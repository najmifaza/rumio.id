...
export default function BannerGeneratorClient({ initialAssets }: { initialAssets: MediaAssetType[] }) {
  ...
  const handleImageSelect = (assets: MediaAssetType[]) => {
    if (assets.length > 0) {
      setBgImage(assets[0].url);
    }
  ...
  return (
    <>
              ...
              <div>
                ...
                <div className="flex flex-col gap-3">
                  <div className="flex items-center gap-3 bg-slate-50 p-2 rounded-xl border border-slate-200">
                    <img src={bgImage} className="w-16 h-16 object-cover rounded-lg border border-slate-200 bg-white" />
                    <div className="flex-1 overflow-hidden">
                      <p className="text-xs font-medium text-slate-500 truncate">Gambar saat ini</p>
                    </div>
                  </div>
                  <button
      ...
      {/* Modal Galeri Media (menggunakan MediaPickerModal) */}
      <MediaPickerModal 
