  ...
  return (
    <div>
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-8 gap-4">
        <div>
          <h1 className="text-3xl font-black text-[#0B1528] mb-1">
            Daftar Blog & Artikel
          </h1>
          <p className="text-slate-500 font-medium">
            Kelola semua konten blog Anda di sini.
          </p>
        </div>
                  ...
                  >
                    <td className="px-6 py-4">
                      <div className="flex items-center gap-4">
                        ...
                        <div>
                          <p className="font-bold text-[#0B1528] text-[15px] mb-0.5 line-clamp-1">
                            {blog.title}
                          </p>
                      ...
                      <div className="flex items-center justify-end gap-2">
                        <Link href={`/blog/${blog.slug}`} target="_blank">
                          <Button
                            variant="outline"
                            size="icon"
                            className="w-9 h-9 rounded-lg border-slate-200 text-slate-500 hover:text-blue-600 hover:bg-blue-50"
                          >
                        ...
                        <Link href={`/admin/blogs/${blog.id}/edit`}>
                          <Button
                            variant="outline"
                            size="icon"
                            className="w-9 h-9 rounded-lg border-slate-200 text-slate-500 hover:text-amber-600 hover:bg-amber-50"
                          >
