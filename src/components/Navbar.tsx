        ...
        >
          ...
          <div className="hidden md:flex items-center gap-3">
            <Button
              ...
              className="inline-flex gap-2 text-slate-700 bg-white hover:bg-slate-50 border-slate-200 rounded-lg px-4 py-2 font-medium"
            >
              <Search className="w-4 h-4 text-amber-500" />
              Carikan Properti
            </Button>
            <Button
              className="inline-flex gap-2 rounded-lg px-4 py-2 font-semibold bg-[#25D366] hover:bg-[#20b858] text-white border-none shadow-sm transition-colors"
            >
