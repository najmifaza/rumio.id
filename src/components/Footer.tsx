        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
          ...
          <div className="space-y-6">
            ...
            <p className="text-slate-400 text-sm leading-relaxed">
              Rumio.id adalah platform properti terpercaya yang membantu Anda
              menampilkan properti dengan Virtual Tour 360°, Landing Page
              Eksklusif, dan QR Code otomatis untuk menjangkau lebih banyak
              calon pembeli.
            </p>
            <div className="flex items-center gap-4">
              ...
              {socials.instagram && (
                <a
                  ...
                  className="w-10 h-10 rounded-full bg-slate-800 flex items-center justify-center text-slate-400 hover:bg-[#D98A2C] hover:text-white transition-all"
                >
                  <svg
                    className="w-5 h-5"
                    viewBox="0 0 24 24"
